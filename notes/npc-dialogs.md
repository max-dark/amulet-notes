...
Реплики и варианты ответов, которые начинаются с `eval: `, являются php-скриптами и обрабатываются через функцию `eval`.
В `eval` могут изменяться title и ID.
...
Банкиром считается NPC, имеющий в диалоге непустую тему разговора с ID `bank`.
