...
* `char` - имя/название и состояние. [Описание](npc-char.md)
* `war` - боевые характеристики. [Описание](npc-war.md)

Дополнительные:
* `bank` - список товаров у торговцев
* `equip` - список предметов, что надето
* `items` - список предметов в инвентаре
* `itemsrnd` - список случайных предмето в инвентаре при респе
